...
namespace RG_GameCamera.CharacterController
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        public void Activate(bool status)
        {
            ...
            //
            // disable smooth physics when using AI move
            //
//            gameObject.GetComponent<Rigidbody>().interpolation = status
//                ? RigidbodyInterpolation.None
//                : RigidbodyInterpolation.Interpolate;
//            var smoother = gameObject.GetComponentInChildren<SmoothFollowPhysics>();
//
//            if (smoother)
//            {
//                smoother.Enabled = !status;
//            }
        }
