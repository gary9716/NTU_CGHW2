...
namespace RG_GameCamera.Modes
{
    ...
    public abstract class CameraMode : MonoBehaviour
    {
        ...
        /// <summary>
        /// this will recalculate and use camera rotation from the previous camera mode
        /// </summary>
        public bool preserveTransitionRotation;
        ...
        protected float defaultAngleX;
        protected float defaultAngleY;
        ...
        /// </summary>
        public virtual void OnActivate(Modes.Type previousMode)
        {
        }
