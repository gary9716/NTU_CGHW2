...
namespace RG_GameCamera
{
    ...
    public class ReviewWindowEditor : EditorWindow
    {
		...
		private static string imagePath = "/EditorFiles/logo.png";
        ...
        [MenuItem("Window/GameCamera/Review")]
        static void Init()
        {
        ...
        void OnGUI()
        {
			...
			EditorGUILayout.LabelField("Rate GameCamera!", EditorStyles.boldLabel);
            ...
            {
                UnityEditorInternal.AssetStore.Open("content/18760"); //MODIFY
                DisableRating();
            }
