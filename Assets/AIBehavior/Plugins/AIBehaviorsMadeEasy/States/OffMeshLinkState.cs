...
namespace AIBehavior
{
	public class OffMeshLinkState : BaseState
	{
		...
		{
			SerializedProperty jumpDelayProperty = stateObject.FindProperty("jumpDelay");
			SerializedProperty transitionStateProperty = stateObject.FindProperty("transitionState");
			...
			EditorGUILayout.PropertyField(jumpDelayProperty);

			GUILayout.BeginHorizontal();
			GUILayout.Label("Transition State: ");
			transitionStateProperty.objectReferenceValue = AIBehaviorsStatePopups.DrawEnabledStatePopup(fsm, transitionStateProperty.objectReferenceValue as BaseState) as BaseState;
